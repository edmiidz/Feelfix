...
//    		String mydate = java.text.DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime());
    		...
    		editTextfeeling=(EditText)rootView.findViewById(R.id.EditText_feeling);
...
//    				}
    		...
    		ok_dailog.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				...
    				String datatm=datePicker.getDayOfMonth()+"-"+(datePicker.getMonth()+1)+"-"+datePicker.getYear();
    				datatm=datatm+" "+timePicker.getCurrentHour()+":"+timePicker.getCurrentMinute()+":"+i1;
