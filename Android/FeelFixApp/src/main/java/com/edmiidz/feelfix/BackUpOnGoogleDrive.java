...
public class BackUpOnGoogleDrive extends Activity {
	...
	/*private String q="title contains 'spotcheck-backup' and mimeType = 'application/vnd.google-apps.spreadsheet' and trashed = false";*/
		...
		Drive drive = new Drive.Builder(transport, jsonFactory, credential)
			...
			.setJsonHttpRequestInitializer(
				new GoogleKeyInitializer(
					"AIzaSyB1_oj8OzHCv3T7It-PTxAziVUXVyzZ3AQ")).build();
		if (drive != null) {
		}*/
			...
			if (resultCode == RESULT_OK && data != null
				...
				if (accountName != null) {
					...
					try {
			            ...
			            GoogleAuthUtil.getToken(BackUpOnGoogleDrive.this,
			            	accountName, "oauth2:" + DriveScopes.DRIVE_FILE,
			                null);//, mAuthority, mSyncBundle);
			            } 
			        catch (Exception e) {
			            Log.e("BackUpOnGoogleDrive", "error can't get token GREG GREG GREG", e);
			        }
	...
	protected Dialog onCreateDialog(int id) {
		...
		case progress_bar_type: // we set this to 0
			...
			System.out.println("Please wait While Data is Uploading on Google Drive");
