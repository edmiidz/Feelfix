...
public class EditRecord extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("SilentModeApp", "Nik EditRecord.java");
date.setOnClickListener(new OnClickListener() {
		...
		sex = (RadioButton) findViewById(R.id.check_sex);
		security = (RadioButton) findViewById(R.id.check_security);
		social = (RadioButton) findViewById(R.id.check_social);
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(),
						"Feeling has been sucessfully edited",
		...
		ok_dailog.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int i1=r.nextInt(60-10) + 10;
					...
					Log.d("SilentModeApp", "EditRecord.java  DDDDDDDDDDDDDDDDDDDDD");
	...
	private void insertData() {
        ...
        instincts = instincts.substring(1,instincts.length());
					...
					Log.d("SilentModeApp", "EditRecord");
					
					Log.d("SilentModeApp", instincts);
	...
	private void setRecord(String id2) {
		...
		if (cursor.getCount() > 0) {
			while (cursor.moveToNext()) {
				...
				if (effected_instict.trim().contains("sex")) sex.setChecked(true);
				if (effected_instict.trim().contains("security")) security.setChecked(true);
				if (effected_instict.trim().contains("social")) social.setChecked(true);

					Log.d("SilentModeApp", "EditRecord");
					
					Log.d("SilentModeApp", effected_instict);
