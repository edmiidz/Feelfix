...
public class UploadonGoogleDrive extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.GET_ACCOUNTS)
            ...
            ActivityCompat.requestPermissions(UploadonGoogleDrive.this,
	...
	public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
		if (requestCode == REQUEST_ACCOUNTS) {
			if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
				...
				Toast.makeText(getApplicationContext(), "You have to grant permission to backup to google drive", Toast.LENGTH_LONG).show();
				finish();
			}
    ...
    private void MakeCsvData(SQLiteDatabase db) {
        ...
        try {
            ...
            dataFile = new java.io.File(getCacheDir(), "yourfile.xls");

            df1 = new java.io.File(getCacheDir(), "spotcheck-skj43gsj.csv");
    ...
    class UploadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                java.io.File fileContent = new java.io.File(getCacheDir(), "spotcheck-skj43gsj.csv");
